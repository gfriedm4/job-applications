...
- Escape key closes open modals and returns from detail view to the dashboard list.
- Dashboard funnel metrics and pipeline health summaries.
...
## Import/Export
- Export from `Settings` -> `Data` -> `Import / Export` as a JSON file.
